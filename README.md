...
<b> [Download](https://github.com/BGI-shenzhen/VCF2Dis/archive/v1.44.tar.gz) </b>
...
```php
	Usage: VCF2Dis -InPut  <in.vcf>  -OutPut  <p_dis.mat>
		...
		-help                Show more help [hewm2008 v1.44]
...
#### method 1
   Upload the <b>p_dis.mat</b> to the website [fastme (http://www.atgc-montpellier.fr/fastme/)](http://www.atgc-montpellier.fr/fastme/), select <b>Data Type</b> to the  <b>Distance matrix </b>,Click the bottom twist <b>execute & email results</b>. you will get the <b>p_dis_mat_fastme-tree.nwk</b> , and Email not mandatory;
...
</br>How to Install PHYLIPNEW please Click on <b> [here](https://github.com/BGI-shenzhen/VCF2Dis/blob/master/Install.NJ.en.md)</b> or Click on <b>[here(Chinese)](https://github.com/BGI-shenzhen/VCF2Dis/blob/master/Install.NJ.cn.md)</b>
```
      #    3.1 Run  PHYLIP
